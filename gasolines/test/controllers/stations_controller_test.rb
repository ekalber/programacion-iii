...
class StationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post stations_url, params: { station: { address: @station.address, flag: @station.flag, max_liters: @station.max_liters } }
    end
  ...
  test "should update station" do
    patch station_url(@station), params: { station: { address: @station.address, flag: @station.flag, max_liters: @station.max_liters } }
