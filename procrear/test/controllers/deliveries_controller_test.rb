...
class DeliveriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create delivery" do
    assert_difference('Delivery.count') do
      post deliveries_url, params: { delivery: { amount: @delivery.amount, date: @delivery.date, loan_id: @delivery.loan_id } }
    end
  ...
  test "should update delivery" do
    patch delivery_url(@delivery), params: { delivery: { amount: @delivery.amount, date: @delivery.date, loan_id: @delivery.loan_id } }
